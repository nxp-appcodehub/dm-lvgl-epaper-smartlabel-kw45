...
#define gHciLeReadLocalSupportedHadmCapabilities_c               0x03FBU
#define gHciLeReadRemoteSupportedHadmCapabilities_c              0x03FAU
#define gHciLeSetHadmSecurityEnable_c                            0x03F9U
#define gHciLeHadmSetDefaultSettings_c                           0x03F8U
#define gHciLeReadLocalFaeTable_c                                0x03F7U
#define gHciLeReadRemoteFaeTable_c                               0x03F6U
#define gHciLeWriteRemoteFaeTable_c                              0x03F5U
#define gHciLeCreateHadmConfig_c                                 0x03F4U
#define gHciLeRemoveHadmConfig_c                                 0x03F3U
#define gHciLeSetAfh_c                                           0x03F2U
#define gHciLeSetHadmProcedureEnable_c                           0x03F1U
#define gHciLeHadmTest_c                                         0x03ECU
#define gHciLeHadmTestEnd_c                                      0x03EBU
#define gHciLeHadmSetProcedureParameters_c                       0x03EAU
...
/*! HCI OGF : 0x3E : Temporary opcode for features under development */
#define gHciLeTempDevelopingOpcodes_c           0x3EU
...
#define HciLeCsCmdOpcode(leCmdOcf)          (HciCmdOpcode(gHciLeTempDevelopingOpcodes_c, leCmdOcf))
