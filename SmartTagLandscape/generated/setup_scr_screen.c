...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_eanBarcode, 148, 70);
	...
	ui->screen_eanQRCode = lv_qrcode_create(ui->screen, 50, lv_color_hex(0x000000), lv_color_hex(0xffffff));
	...
	lv_obj_set_style_text_font(ui->screen_currencyLabel, &lv_font_montserratMedium_50, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_size(ui->screen_priceLabel, 127, 50);
	...
	lv_obj_set_style_bg_opa(ui->screen_priceLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
