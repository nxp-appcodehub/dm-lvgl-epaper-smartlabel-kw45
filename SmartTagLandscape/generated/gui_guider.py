...
screen_eanBarcode.set_pos(148, 70)
...
screen_eanLabel.set_pos(150, 110)
screen_eanLabel.set_size(139, 12)
...
screen_eanLabel.set_style_text_color(lv.color_hex(0x000000), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_eanLabel.set_style_text_font(test_font("montserratMedium", 13), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_eanLabel.set_style_text_letter_space(1, lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_eanLabel.set_style_bg_opa(0, lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_eanLabel.set_style_pad_left(2, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_eanLabel.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)

# Create screen_eanQRCode
screen_eanQRCode = lv.qrcode(screen, 50, lv.color_hex(0x000000), lv.color_hex(0xffffff))
...
screen_priceLabel.set_size(127, 50)
...
screen_priceLabel.set_style_bg_opa(0, lv.PART.MAIN|lv.STATE.DEFAULT)
